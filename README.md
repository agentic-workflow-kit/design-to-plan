...
It does not ship a runtime, CLI, validator, or schema package — see
[`docs/design/decisions.md`](docs/design/decisions.md), D-009 and D-011. A repo-local deterministic
eval harness exists for development checks only.
