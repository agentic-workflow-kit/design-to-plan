...
| Missing source IDs  | Planner Handoff Summary; DEL-_; VAL-_; STOP-*                                                                                                   |
| Owner               | Technical Design owner                                                                                                                          |
| Reason              | The Planner Handoff Summary is TBD, so there are no stable DEL-_, VAL-_, or STOP-* fact rows to project into stories, evidence, or constraints. |
