...
| Product refs         | `AC-PLAN-001`, `AC-TRACE-001`, `AC-DAG-001`, `AC-EVID-001`, `AC-SCOPE-001` |
...
| --------- | ------------------------------ | --------------------------------------------- | -------------------------------- | ------------------------------------------------ | ----------- |
| STORY-001 | Define design-to-plan contract | `AC-PLAN-001`, `AC-TRACE-001`, `AC-SCOPE-001` | `CTX-001`, `DEL-001`, `STOP-001` | `docs/design/design-to-plan-contract.md`         | None        |
...
| --------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| STORY-001 | Reviewer confirms accepted inputs, required outputs, and refusal behavior are named.            | `AC-SCOPE-001`; `CTX-001`; `STOP-001`; Jig plan identity, story set, authority, policy, stack-seam, and constraint properties. |
...
| Authority and approval needs       | `AC-SCOPE-001`                | `STOP-001`            |
